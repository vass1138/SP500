## ---------------------------
##
## Script name: christmas.R
##
## Purpose of script:  Explore S&P500 around Christmas holiday period
##
##
...
d1 <- get_data(df,"2003-12-25",2,"SARS-CoV-1")
d2 <- get_data(df,"2008-12-25",2,"H1N1")
d3 <- get_data(df,"2013-12-25",2,"Ebola")
d4 <- get_data(df,"2019-12-25",2,"SARS-CoV-2")
